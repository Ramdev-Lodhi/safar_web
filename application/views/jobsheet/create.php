        ...
        <div class="white_shd full margin_bottom_30">
            <div class="full graph_head">
                <div class="col-lg-12 my-2">
                    <h2 class="text-center mb-3">Add New Job Sheet</h2>
                </div>
            ...
            <div class="col-lg-12">
                <div class="padding_infor_info">
                    <form method="post" action="<?php echo base_url('jobsheet/store'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="contractor" id="contractor"
                                ...
                                <?php foreach ($contractor as $contract) { ?>
                                    <option value="<?= $contract->id.'~'.$contract->contractor_name ?>"><?= $contract->contractor_name ?></option>
                                <?php } ?>
                            </select>
