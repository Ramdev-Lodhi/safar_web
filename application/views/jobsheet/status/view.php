  ...
  <div class="white_shd full margin_bottom_30">
    <div class="full graph_head">
      ...
      <div class="d-flex justify-content-end ">
        <a class="btn btn-warning btn-lg" href="<?php echo base_url('jobsheet/status'); ?>"> <i
          ...
          <table id="example" class="table table-bordered table-default table-hover"
            ...
            <thead class="thead-light">
              <tr>
                ...
                <th>Department Recieved Date</th>
                <th>Department Dispatched Date</th>
                <th>Pairs Damage</th>
                <th>Quantity Dispatched</th>
                <th>Sack Sack Weight Dispatched</th>
              </tr>
            </thead>
            <tbody></tbody>
          </table>
