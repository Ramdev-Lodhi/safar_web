        ...
        <div class="padding_infor_info">
            ...
            <div id="b_edit" class="second_edit">
                <form method="post">
                    ...
                    <div class="form-group">
                        <label>Label ID</label>
                        <input class="form-control" type="text" name="label_id_b">
                    </div>
                    <div class="form-group">
                        <label>Article</label>
                    ...
                    <div class="form-group">
                        <label>Godown ID:</label>
                        <input class="form-control" type="number" name="godown_id_b">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <input class="form-control" type="text" name="status_b">
                    </div>
                </form>
            </div>
