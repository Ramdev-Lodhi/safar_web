        ...
        <div class="white_shd full margin_bottom_30">
            <div class="full graph_head">
                ...
                <div class="d-flex justify-content-end ">
                    ...
                    <a class="btn btn-warning btn-lg" href="<?php echo base_url('rawmaterial/raw_material2'); ?>"> <i class="fas fa-angle-left"></i>
                        Back</a>
                </div>
            </div>
            <div class="col-lg-12">
                <div class="padding_infor_info">
                    <form method="post" action="<?php echo base_url('rawmaterial/raw_material2_store'); ?>"  enctype="multipart/form-data">
                                        ...
                                        <div class="add-image">
                                            <div class="drop-zone-small">
                                                ...
                                                <input type="file" name="product-image[]" class="drop-zone-input"
                                                    id="drop-zone-input-1" onchange="previewImage(this.files)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
